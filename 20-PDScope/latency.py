...
if __name__ == "__main__":
    ...
    if args.model=="/home/share/bz/model/Mixtral-8x7B-v0.1" or "mixtral" in args.model.lower():
        model = FiddlerMixtral(args)
        prefix="mix"
    elif args.model=="/home/share/bz/model/Qwen3-30B-A3B" or "qwen" in args.model.lower():
        model = FiddlerQwen(args)
        prefix="qwen"
    elif args.model=="/home/share/bz/model/DeepSeek-V2-Lite" or "deepseek" in args.model.lower():
    ...
    for input_token in [128]:
        for output_token in [32]:
            ...
            for _ in range(1):
                ...
                #NOTE: 测试输出是否正确，后续改为随机生成文本
                batch_texts = [f"please tell me a joke."] * args.batch_size
